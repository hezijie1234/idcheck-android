...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public void setOnSelectImageListener(ImageGridAdapter.onSelectImageListener onSelectImageListener) {
    ...
    class ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (onSelectImageListener != null && data != null) {
                onSelectImageListener.onSelectImage(data);
            }
        }
    }

    public interface onSelectImageListener {
        void onSelectImage(Image image);
    }
}
