...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mImageAdapter.setOnSelectImageListener(new ImageGridAdapter.onSelectImageListener() {
            @Override
                    ...
                    if (i == 0) {
                        ...
                        if (mode == MODE_MULTI) {
                            ...
                            for (int n = 0; n < data.size(); n++) {
                                Image img = data.get(n);
                                images.add("file://" + img.path);
                            }
                            Intent intent = new Intent(getContext(), MultiImagePreviewActivity.class);
