...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Activity context){
		this(context, LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
	}
	
	public TitlePopup(Activity context, int width, int height){
		...
		setContentView(LayoutInflater.from(mContext).inflate(R.layout.layout_title_popup, null));
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if(convertView == null){
					...
					textView.setTextColor(mContext.getResources().getColor(R.color.text_6));
