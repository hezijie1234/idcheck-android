...
import com.huiyu.tech.zhongxing.models.EmergencyNoticeDetailModel;
 ...
 * 紧急布控详情
 */
public class EmergencyNoticeDetailActivity extends ZZBaseActivity implements OnResponseListener {
    ...
    private void initData(){
        ...
        ApiImpl.getInstance().getEmergencyNoticeDetail(id,this);
    }
